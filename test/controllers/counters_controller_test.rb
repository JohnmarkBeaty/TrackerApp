...
class CountersControllerTest < ActionController::TestCase
  ...
  test "should create counter" do
    assert_difference('Counter.count') do
      post :create, counter: { currentValue: @counter.currentValue, stepSize: @counter.stepSize, title: @counter.title }
    end
  ...
  test "should update counter" do
    patch :update, id: @counter, counter: { currentValue: @counter.currentValue, stepSize: @counter.stepSize, title: @counter.title }
    assert_redirected_to counter_path(assigns(:counter))
  end
